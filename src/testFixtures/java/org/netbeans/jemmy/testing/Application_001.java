...
public class Application_001 extends JDialog {
    ...
    public Application_001() {
        ...
        editable.getEditor().addActionListener(e -> editableModel.addElement(editable.getEditor().getItem()));
        ...
        pane.add(list);
        String[] non_editable_contents = { "non_editable_one", "non_editable_two", "non_editable_three",
                                           "non_editable_four" };
    ...
    public static void main(String[] argv) {
        EventQueue.invokeLater(() -> new Application_001().setVisible(true));
    }
}
