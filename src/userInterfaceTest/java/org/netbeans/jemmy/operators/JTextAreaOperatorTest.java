...
class JTextAreaOperatorTest {
    ...
    void testConstructor() {
       ...
       assertNotNull(operator3);
        JTextAreaOperator operator4 = new JTextAreaOperator(operator, "JTextAreaOperatorTest", StringComparators.strict());
       assertNotNull(operator4);
    }

    @Test
    void testFindJTextArea() {
        JTextArea textArea1 = JTextAreaOperator.findJTextArea(frame, "JTextAreaOperatorTest", StringComparators.caseInsensitiveSubstring());
    ...
    void testWaitJTextArea() {
        JTextArea textArea1 = JTextAreaOperator.waitJTextArea(frame, "JTextAreaOperatorTest", StringComparators.caseInsensitiveSubstring());
       assertNotNull(textArea1);
