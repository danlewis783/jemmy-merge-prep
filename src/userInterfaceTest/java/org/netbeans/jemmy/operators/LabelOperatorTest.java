...
class LabelOperatorTest {
    ...
    @Test
    void testWaitLabel() {
        LabelOperator.waitLabel(frame, "LabelOperatorTest", StringComparators.caseInsensitiveSubstring());
        LabelOperator.waitLabel(frame, ComponentPredicates.byName("LabelOperatorTest"));
    }
