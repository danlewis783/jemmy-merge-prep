...
class JSpinnerOperatorTest {
    ...
    void dateScrollAdjuster() {
        ...
        jSpinnerOp.setModel(new SpinnerDateModel(new Date(), new Date(System.currentTimeMillis() - 3600),
        ...
        Date date = new Date();
        jSpinnerOp.setModel(new SpinnerDateModel(date, new Date(System.currentTimeMillis() - 3600),
                new Date(System.currentTimeMillis() + 3600), Calendar.MINUTE));
    ...
    void toStringScrollAdjuster() {
        ...
        assertNotNull(jSpinnerOp);
        jSpinnerOp.setModel(new SpinnerListModel());
        ToStringScrollAdjuster adjuster = new ToStringScrollAdjuster(jSpinnerOp, "1", STRICT,
    ...
    void exactScrollAdjuster() {
        ...
        assertNotNull(jSpinnerOp);
        jSpinnerOp.setModel(new SpinnerListModel());
        ExactScrollAdjuster adjuster = new ExactScrollAdjuster(jSpinnerOp, "1",
                                                 ScrollAdjuster.INCREASE_SCROLL_DIRECTION);
        assertNotNull(adjuster);
        assertEquals(SwingConstants.VERTICAL, adjuster.getScrollOrientation());
    }
