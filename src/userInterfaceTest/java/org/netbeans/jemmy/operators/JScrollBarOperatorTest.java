...
class JScrollBarOperatorTest {
    ...
    void testConstructor() {
       ...
       assertNotNull(operator1);
        JScrollBarOperator operator2 = new JScrollBarOperator(operator,
                                           PredicatesJ.byName("JScrollBarOperatorTest"));
    ...
    void testFindJScrollBar() {
       ...
       assertNotNull(scrollBar1);
        JScrollBar scrollBar2 = JScrollBarOperator.findJScrollBar(frame,
                                    PredicatesJ.byName("JScrollBarOperatorTest"));
    ...
    void testWaitJScrollBar() {
       ...
       assertNotNull(scrollBar1);
        JScrollBar scrollBar2 = JScrollBarOperator.waitJScrollBar(frame,
                                    PredicatesJ.byName("JScrollBarOperatorTest"));
       assertNotNull(scrollBar2);
    }
