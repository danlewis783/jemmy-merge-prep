...
class jemmy_002 {
    ...
    void test() {
        ...
        try {
            ...
            mb0.closeSubmenus();
            JMenuItemByTextPredicate menuPredicate1 = new JMenuItemByTextPredicate("menu",
                                                                StringComparators.strict());
            JMenuItemByTextPredicate menuPredicate2 = new JMenuItemByTextPredicate("submenu",
                                                                StringComparators.strict());
            List<Predicate<Component>> predicates = Collections.unmodifiableList(Arrays.asList(menuPredicate1,
                                                              menuPredicate2));
            ...
            assertEquals("menu", mb0.showMenuItem("menu", StringComparators.strict()).getText());
            assertEquals("menuItem",
                         mb0.showMenuItem("menu|submenu|subsubmenu|menuItem", StringComparators.strict()).getText());
            ...
            mb0.pushMenu("menu", StringComparators.strict());
            assertEquals("subsubmenu",
                         mb0.showMenuItem("menu|submenu|subsubmenu", StringComparators.strict()).getText());
            ...
            TimeoutOverride override3 = Timeouts.override(TimeoutKey.ComponentOperator_WaitComponentEnabledTimeout, 1000L);
            ...
            assertTrue(((source1.getUI() == null) && (mb0.getUI() == null)) || source1.getUI().equals(mb0.getUI()));
            assertEquals(source1.isBorderPainted(), mb0.isBorderPainted());
            assertEquals(source1.isSelected(), mb0.isSelected());
            assertNotNull(mb0.pushMenu("menu|submenu|subsubmenu|menuItem", StringComparators.strict()));
            JLabelOperator jLabelOp = new JLabelOperator(win0, "Menu \"menu/menuItem\" has been pushed",
                                                StringComparators.strict());
