...
class jemmy_001 {
    ...
    private Application_001 application_001;

    @Test
    void test() throws Exception {
        EventQueue.invokeAndWait(() -> application_001 = new Application_001());
        EventQueue.invokeLater(() -> application_001.setVisible(true));
        EventQueue.invokeAndWait(() -> {});
        System.setProperty("jemmy.dump.a11y", "on");
        JDialog jDialog = JDialogOperator.waitJDialog("Application_001", StringComparators.strict());
        ...
        JScrollPaneOperator jScrollPaneOp = new JScrollPaneOperator(JScrollPaneOperator.findJScrollPane(jDialog,
                                                PredicatesJ.alwaysTrue()));
        JComboBoxOperator jComboOp1 = new JComboBoxOperator(JComboBoxOperator.findJComboBox(jDialog, "editable_one",
                                          StringComparators.strict(), 0));
        ...
        JComboBoxOperator jComboOp5 = new JComboBoxOperator(JComboBoxOperator.findJComboBox(jDialog,
                                          "non_editable_one", StringComparators.strict(), 0));
        ...
        JListOperator jListOp2 = new JListOperator(jDialogOp1, "two", StringComparators.caseInsensitiveSubstring(), 1, 0);
        ...
        JComboBoxOperator jComboOp7 = new JComboBoxOperator(jDialogOp1,
                                          PredicatesJ.byName("on_e", StringComparators.caseInsensitiveSubstring()));
    ...
    private void testJTextComponent(JTextComponentOperator op) {
        ...
        assertTrue(((src.getCaret() == null) && (op.getCaret() == null)) || src.getCaret().equals(op.getCaret()));
        ...
        assertTrue(((src.getKeymap() == null) && (op.getKeymap() == null)) || src.getKeymap().equals(op.getKeymap()));
        assertTrue(((src.getMargin() == null) && (op.getMargin() == null)) || src.getMargin().equals(op.getMargin()));
        assertTrue(
            ((src.getPreferredScrollableViewportSize() == null) && (op.getPreferredScrollableViewportSize() == null))
        ...
        assertTrue(((src.getText() == null) && (op.getText() == null)) || src.getText().equals(op.getText()));
    ...
    private void testWindow(WindowOperator op) {
        ...
        assertTrue(((src.getOwner() == null) && (op.getOwner() == null)) || src.getOwner().equals(op.getOwner()));
    ...
    private void testJComboBox(JComboBoxOperator op) {
        ...
        assertTrue(((src.getEditor() == null) && (op.getEditor() == null)) || src.getEditor().equals(op.getEditor()));
        ...
        assertTrue(((src.getModel() == null) && (op.getModel() == null)) || src.getModel().equals(op.getModel()));
