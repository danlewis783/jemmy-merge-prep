...
class jemmy_035 {
    ...
    void test() {
        ...
        assertTrue(CheckInside.isInside(butt44Op, scrollPaneOp, 0, 0, butt44Op.getWidth(), butt44Op.getHeight()));
        scrollPaneOp.setValues(0, 0);
        ComponentOperator butt00Op = new ComponentOperator(butt00);
        assertTrue(CheckInside.isInside(butt00Op, scrollPaneOp, 0, 0, butt00Op.getWidth(), butt00Op.getHeight()));
        ...
        assertTrue(CheckInside.isInside(butt40Op, scrollPaneOp, 0, 0, butt40Op.getWidth(), butt40Op.getHeight()));
        ...
        assertTrue(CheckInside.isInside(butt11Op, scrollPaneOp, 0, 0, butt11Op.getWidth(), butt11Op.getHeight()));
        scrollPaneOp.scrollToComponent(butt33);
        ComponentOperator butt33Op = new ComponentOperator(butt33);
        assertTrue(CheckInside.isInside(butt33Op, scrollPaneOp, 0, 0, butt33Op.getWidth(), butt33Op.getHeight()));
        scrollPaneOp.scrollToHorizontalValue(0.5);
        scrollPaneOp.scrollToVerticalValue(0.5);
        assertTrue(CheckInside.isInside(butt22Op, scrollPaneOp, 0, 0, butt22Op.getWidth(), butt22Op.getHeight()));
    }
}
